...
public final class DomainExceptionsMessagesConstants {
    ...
    public static final String PAGE_SIZE_NEGATIVE_MESSAGE = "Page size cannot be negative.";
    ...
    private DomainExceptionsMessagesConstants() {
