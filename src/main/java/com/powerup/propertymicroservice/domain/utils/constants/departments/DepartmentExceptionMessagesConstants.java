...
public class DepartmentExceptionMessagesConstants {
    ...
    public static final String DEPARTMENT_NOT_FOUND_EXCEPTION = "No department was found with the name: ";
    ...
    private DepartmentExceptionMessagesConstants() {
